...
public class ReporteLuzActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reporte_luz);
        ...
        btnGuardar.setOnClickListener(v -> enviarReporteLuz());
    }

    private void enviarReporteLuz() {
        ...
        Call<ReporteResponse> call = apiService.enviarReporteLuz(
                nombre,
                calle1,
                calle2,
                colonia,
        ...
        call.enqueue(new Callback<ReporteResponse>() {
            ...
            public void onResponse(Call<ReporteResponse> call, Response<ReporteResponse> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(ReporteLuzActivity.this, "Reporte enviado correctamente", Toast.LENGTH_LONG).show();
                    finish();
                } else {
                    Toast.makeText(ReporteLuzActivity.this, "Error en el servidor", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<ReporteResponse> call, Throwable t) {
                Toast.makeText(ReporteLuzActivity.this, "Fallo de conexión: " + t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
